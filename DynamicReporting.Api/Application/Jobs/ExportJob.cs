...
{
    public async Task ExportJobAsync(int reportDefinitionId, List<FilterCondition>? filtersList, string type, Guid reportGuid, CancellationToken cancellationToken = default)
    {
