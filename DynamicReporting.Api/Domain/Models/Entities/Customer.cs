...
{
    [Key] [SwaggerSchema("شناسه مشتری")] public long CustomerId { get; set; }
    ...
    [SwaggerSchema("سفارشات مشتری")] public virtual ICollection<Order> Orders { get; set; } = new List<Order>();
}